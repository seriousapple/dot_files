...
mp.add_key_binding("LEFT", "mpvrcious-sub-seek-back", function() mp.commandv("sub_seek", "-1") end)
mp.add_key_binding("RIGHT", "mpvacious-sub-seek-forward", function() mp.commandv("sub_seek", "1") end)
